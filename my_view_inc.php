	...
	<td class="nowrap width-13 my-buglist-id">
		<?php
			...
			if( !bug_is_readonly( $t_bug->id ) && access_has_bug_level( $t_update_bug_threshold, $t_bug->id ) ) {
				echo '<a class="edit" href="' . string_get_bug_update_url( $t_bug->id ) . '"><i class="fa fa-pencil blue" title="' . lang_get( 'update_bug_button' ) . '"></i></a>&nbsp;';
			}
			...
			if( $t_attachment_count > 0 ) {
				...
				echo '<i class="fa fa-paperclip blue" title="' . $t_alt_text . '"></i></a>&nbsp;';
			}
